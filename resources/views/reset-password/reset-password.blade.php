						...
						<div class="row justify-content-sm-center h-100">
							<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
								...
								<div class="card shadow-lg">
									<iframe id="iframe" onload="resizeIframe()" onchange="resizeIframe()" src="{{ route('reset-password-success', ['token' => $token]) }}" style="width: 100%; border-top-right-radius: 5px; border-top-left-radius: 5px;"></iframe>
