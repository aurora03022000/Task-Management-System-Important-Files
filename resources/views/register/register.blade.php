			...
			<div class="row justify-content-sm-center h-100">
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9" style="position: relative;">
					...
					<div class="card shadow-lg" style="border-top: 5px solid #236712;">
						<iframe id="iframe" onload="resizeIframe()" onchange="resizeIframe()" src="{{ route('backRegisterID') }}" style="width: 100%; border-top-right-radius: 5px; border-top-left-radius: 5px;"></iframe>
						<div class="card-footer py-3 border-0">
							<div class="text-center" style="font-size: 15px; ">
								Already have an account? <a href="{{ route('login') }}" class="text-dark login-a">Login</a>
							</div>
						</div>
					</div>
				</div>
